export const aboutMe = [
    {
        title: "About me",
        description:
        `💫🚀 Actualmente impulsada por los desafíos, tomé uno más: mi transformación de Ingeniera Industrial, con 5 años de experiencia en Calidad y Mejora Continua, a Desarrolladora Web.
            Siempre tuve esa sensación de adentrarme en el mundo de la programación, así que decidí sumergirme felizmente participando en Laboratoria, 
            donde comencé mi desarrollo como Desarrolladora Frontend, colaborando y trabajando en equipo en diversos proyectos.
            Además, recientemente completé mi primer curso en Java y actualmente estoy participando en varios cursos de React y JavaScript.`
    }
];
